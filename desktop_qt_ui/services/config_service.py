...
class ConfigService(QObject):
    ...
    def __init__(self, root_dir: str):
        ...
        # 将当前预设同步到进程环境变量，供后端/日志记录使用
        try:
            os.environ['MANGA_TRANSLATOR_PRESET'] = getattr(self.current_config.app, 'current_preset', '默认')
        except Exception:
            pass
    ...
    def set_current_preset(self, preset_name: str) -> bool:
        ...
        try:
            ...
            # 同步到进程环境变量（供 AI_METRICS 记录使用）
            os.environ['MANGA_TRANSLATOR_PRESET'] = preset_name
